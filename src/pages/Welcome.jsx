...
export default function WelcomePage() {
  ...
  const opactiyCity=useTransform(scrollY,[0,200,300,500],[1,0.5,0.4,0])
  const yHero=useTransform(scrollY,[0,100,200],[0,-10,-90])
  const opactiyHero=useTransform(scrollY,[0,200,300,500],[1,1,0.4,0])
    ...
    <>
      <header id="welcome-header">
        ...
        <motion.img
          ...
          id="city-image"
        />
        <motion.img style={{opacity:opactiyHero,y:yHero}} src={heroImg} alt="A superhero wearing a cape" id="hero-image"/>
      </header>
